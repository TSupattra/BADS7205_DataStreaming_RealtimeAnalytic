...
def show_game_over(screen_sizeX, screen_sizeY, top_score, score):
	...
	# Write text
	message_display('GAME OVER', font_large, yellow, int(screen_sizeX/2), int(screen_sizeY * 1/5))
	message_display('Your Score: ' + str(your_score), yellow, int(screen_sizeX/2), int(screen_sizeY *3/5))
	message_display('Top Score:  ' + str(top_score), yellow, int(screen_sizeX/2), int(screen_sizeY *4/5))
	message_display('Press Return to continue', font_medium, yellow, int(screen_sizeX/2), int(screen_sizeY *5/5))
...
#			score += level_score_increase
		...
		if game_over:
			...
			show_game_over(screen_sizeX, screen_sizeY, score, top_score)
